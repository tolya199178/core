...
$templateCache.put("app/layout/partials/navigation.tpl.html","<aside id=\"left-panel\">\n\n    <!-- User info -->\n    <!--<div login-info></div>-->\n    <!-- end user info -->\n\n    <nav>\n        <!-- NOTE: Notice the gaps after each icon usage <i></i>..\n        Please note that these links work a bit different than\n        traditional href=\"\" links. See documentation for details.\n        -->\n\n        <ul data-smart-menu>\n\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.news\">\n                    <i class=\"fa fa-lg fa-fw fa-file\"></i> <span class=\"menu-item-parent\">{{getWord(\'News\')}}</span></a>\n            </li>\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.videos\">\n                    <i class=\"fa fa-lg fa-fw fa-video-camera\"></i> <span class=\"menu-item-parent\">{{getWord(\'Videos\')}}</span></a>\n            </li>\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.images\">\n                    <i class=\"fa fa-lg fa-fw fa-image\"></i> <span class=\"menu-item-parent\">{{getWord(\'Images\')}}</span></a>\n            </li>\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.users\">\n                    <i class=\"fa fa-lg fa-fw fa-user\"></i> <span class=\"menu-item-parent\">{{getWord(\'Users\')}}</span></a>\n            </li>\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.contactUs\">\n                    <i class=\"fa fa-lg fa-fw fa-phone\"></i> <span class=\"menu-item-parent\">{{getWord(\'Contact Us\')}}</span></a>\n            </li>\n            <li data-ui-sref-active=\"active\">\n                <a data-ui-sref=\"app.admin.subscribers\">\n                    <i class=\"fa fa-lg fa-fw fa-edit\"></i> <span class=\"menu-item-parent\">{{getWord(\'Subscribers\')}}</span></a>\n            </li>\n\n        </ul>\n\n        <!-- NOTE: This allows you to pull menu items from server -->\n        <!-- <ul data-smart-menu-items=\"/api/menu-items.json\"></ul> -->\n    </nav>\n\n  <span class=\"minifyme\" data-action=\"minifyMenu\" minify-menu>\n    <i class=\"fa fa-arrow-circle-left hit\"></i>\n  </span>\n\n</aside>");
...
angular.module('app.admin').controller('ContactUsController', function ($scope) {


});
'use strict';

angular.module('app.admin').controller('ImagesController', function ($scope) {


});
'use strict';

angular.module('app.admin').controller('NewsController', function ($scope) {


});
'use strict';

angular.module('app.admin').controller('SubscribersController', function ($scope) {


});
'use strict';

angular.module('app.admin').controller('UsersController', function ($scope) {


});
'use strict';

angular.module('app.admin').controller('VideosController', function ($scope) {
...
angular.module('app.home').controller('AboutController', function ($scope, $window) {
...
angular.module('app.home').controller('NewsController', function ($scope, $window) {

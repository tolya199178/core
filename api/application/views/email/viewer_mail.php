                      ...
                      <tr>
                        <td align="center" valign="top" width="600" class="flexibleContainerCell">
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                              <td valign="top" class="textContent">
                                  <?php echo $sender; ?> has invited you to review a presentation <b><?php echo $presentation; ?></b>
                                for the project called <b><?php echo $project; ?></b>.
                                  <?php
                                  if (!empty($message)) {

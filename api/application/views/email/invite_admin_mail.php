...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Qwire Administrator Invitation</title>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        We would like you to be administrator of <?php echo SITE_NAME ?>, <br><br>
                                                                                </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td valign="top" class="textContent">
                                                                                                                        ...
                                                                                                                        <tr>
                                                                                                                            <td align="center" valign="top" width="600" class="flexibleContainerCell">
                                                                                                                                ...
                                                                                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td valign="top" class="textContent">
                                                                                                                                            Activate your account by clicking on below link.
                                                                                                                                        </td>
                                                                                                                                        <td valign="top" class="textContent">
                                                                                                                                            <a href="<?php echo $activation_link; ?>">Click me</a>
                                                                                                                                        </td>
                                                                                                                                    </tr>

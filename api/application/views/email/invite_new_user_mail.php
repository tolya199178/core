...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Presentation Viewer Invitation</title>
                                                                        ...
                                                                        Hello <?php echo $userName ?>, <br><br>
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" class="textContent">
                                                                                        ...
                                                                                        <?php echo $login_data['fname'] . ' ' . $login_data['lname']; ?> Has assigned you to view presentation <?php echo $presentation; ?>, but it seems you don’t yet have an account . Click​  below link ​ to get started! 
                                                                                    </td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td valign="top" class="textContent">
                                                                                        <b>Your  access details are as follows:</b><br><br>
                                                                                                </td>
                                                                                                </tr>
                                                                                                </table>
                                                                                                <!-- // CONTENT TABLE -->

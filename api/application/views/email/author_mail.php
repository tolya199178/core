                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                              <td valign="top" class="textContent">
                                Hello <?php echo $receiver; ?>,
                              </td>
                            </tr>
                            <tr>
                              <td valign="top" class="textContent">
                                The Presenter <?php echo $sender; ?> has assigned you as ​ Author​​ of the project <b><?php echo $project; ?></b>
                                <?php
                                if (!empty($message)) {
                                    echo '<br><br><strong>Presenter\'s message:</strong><br>' . $message . '<br><br>';
                                }
                                ?>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td valign="top" class="textContent">
                                To accept the invitation. To learn more about your assigned role in QwirePresent,
                              </td>
                            </tr>
                          </table>
                          <!-- // CONTENT TABLE -->
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="260" class="emailButton">
                            <tr>
                              <td align="center" valign="middle" class="buttonContent">
                                <a href="<?php echo $login; ?>" target="_blank">Click here​</a>
                              </td>
                            </tr>
                          </table>
                          <!-- // CONTENT TABLE -->

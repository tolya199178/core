...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            /*////// GENERAL STYLES //////*/
            body, #bodyTable{background-color:#1B2431;}
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        ...
                                                                        This email was sent automatically by Qwire Present in response to your request to reset  
                                                                        your password. This is done for your protection? only you can take the next step in the 
                                                    ...
                                                    <tr>
                                                        <td align="center" valign="top" width="600" class="flexibleContainerCell">
                                                           ...
                                                           <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                        Your password has been reset you can access your account through below details
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td valign="top" class="textContent">
                                                                ...
                                                                <?php if ($subject == 'Forgot Password') { ?>
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            Password:
                                                                ...
                                                                <tr>
                                                                    <tr>
                                                                        <td align="center" valign="middle" class="buttonContent">
                                                                            <a href="<?php echo $login; ?>" target="_blank" >Login</a> 
                                                                        </td>
                                                                    </tr>
                                                                </tr>
